...
// MyPaint.cpp: определяет поведение классов для приложения.
//
...
// Единственный объект CMyPaintApp

CMyPaintApp theApp;


// Инициализация CMyPaintApp
...
// Обработчики сообщений CMyPaintApp
